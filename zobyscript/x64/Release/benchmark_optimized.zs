# Optimized Benchmark - Tests All Optimizations

print("=== Optimized Performance Test ===")
print("")

# Test 1: 1 million integer additions (tests integer fast path + constant folding)
...
# Test 2: Iterative fibonacci (no recursion overhead)
...
# Test 4: Nested loops (tests loop optimization)
